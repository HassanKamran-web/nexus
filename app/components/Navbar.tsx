...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-16 w-full max-w-[100vw] bg-main-bg/80 backdrop-blur-md border-b-2 border-border-ui z-50 flex items-center justify-between px-4 sm:px-6 md:px-12 overflow-hidden">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        {status === "loading" ? (
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Link 
              href="/chat" 
              className="bg-primary hover:opacity-90 cursor-pointer text-white px-3 py-1.5 sm:px-4 sm:py-1.5 rounded-full font-bold transition-all shadow-lg shadow-primary/20 active:scale-95 flex items-center justify-center gap-1"
            >
              <MessageSquare size={14} className="sm:size-4.5" />
          ...
          >
            <FcGoogle size={14} className="sm:size-4" />
